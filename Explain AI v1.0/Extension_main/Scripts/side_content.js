(function() {
    ...
    // Get all resource URLs when the script loads to avoid context invalidation errors
    let iconURL = '';
    let settingsIconURL = '';
    let closeIconURL = '';
    try {
        iconURL = chrome.runtime.getURL('./Extension_main/Scripts/icon.png');
        settingsIconURL = chrome.runtime.getURL('./Extension_main/Scripts/settings.png');
        closeIconURL = chrome.runtime.getURL('./Extension_main/Scripts/close.png');
    } catch (error) {
        console.error('Failed to get resource URLs:', error);
        return; // Exit if we can't get the resource URLs
    }
            ...
            <div class="popup-header">
                ...
                <div class="popup-controls">
                    <button class="settings-btn">
                        <img src="${settingsIconURL}" alt="Settings" style="width: 40px; height: 40px; display: block;">
                    </button>
                    <button class="close-btn">
                        <img src="${closeIconURL}" alt="Close" style="width: 40px; height: 40px; display: block;">
                    </button>
                </div>
            </div>
